...
?>
<?php
add_action( 'wp_ajax_qcld_recommend_support_function_first_ajax', 'qcld_recommend_support_function_first_ajax' );

if( !function_exists('qcld_recommend_support_function_first_ajax') ){

    function qcld_recommend_support_function_first_ajax(){
...
add_action( 'wp_ajax_qcld_recommend_support_function_second_ajax', 'qcld_recommend_support_function_second_ajax' );

if( !function_exists('qcld_recommend_support_function_second_ajax') ){

    function qcld_recommend_support_function_second_ajax(){
...
add_action( 'wp_ajax_qcld_recommend_support_function_third_ajax', 'qcld_recommend_support_function_third_ajax' );

if( !function_exists('qcld_recommend_support_function_third_ajax') ){

    function qcld_recommend_support_function_third_ajax(){
...
add_action( 'wp_ajax_qcld_recommend_support_function_forth_ajax', 'qcld_recommend_support_function_forth_ajax' );

if( !function_exists('qcld_recommend_support_function_forth_ajax') ){

    function qcld_recommend_support_function_forth_ajax(){
