...
if( !class_exists('QcldPluginUpgradeToProNotice') )
{
	class QcldPluginUpgradeToProNotice {
		 ...
		 *******************************/
		function qcld_check_if_plugin_page()
		{
		 ...
		 *******************************/
		function qcld_hook_with_plugin_action_links(){
		 ...
		 * Ofcourse, in plugin.php page
		 *******************************/
		function qcld_hook_with_plugin_meta_links(){
		 ...
		 *******************************/
		function qcld_hook_with_plugin_submenu()
		{
		   ...
		   {
			  add_action( 'admin_menu' , array(&$this, 'qcld_func_qc_external_upgrade_link'), 20 );
		   }
		}
		 ...
		 *******************************/
		function qcld_func_qc_external_upgrade_link()
		{
		    global $submenu;
...
$instance_sldf2 = new QcldPluginUpgradeToProNotice();
...
{ 
	...
	$instance_sldf2->plugin_menu_slug = 'comment-link-remove'; //Main Menu Slug
	...
	if( $instance_sldf2->qcld_check_if_plugin_page() )
	{
		$instance_sldf2->qcld_hook_with_plugin_action_links();
		$instance_sldf2->qcld_hook_with_plugin_meta_links();
	}
	
	$instance_sldf2->qcld_hook_with_plugin_submenu();
